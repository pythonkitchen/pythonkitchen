...
Usage ``pythonkitchen [OPTIONS] COMMAND [ARGS]...``

Example command 'welcome' has been added.
- To get your project version, run ``pythonkitchen --version``
- Run the sample command as ``pythonkitchen welcome [OPTIONS] NAME``
"""

from pythonkitchen import __version__
import click
...
def welcome(name, verbose):
    ...
    """
    click.secho(f"Hi {name}. Welcome to pythonkitchen", fg="cyan")
